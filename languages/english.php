...
$LNG['user_success'] = 'გილოცავთ, პროფილი წარმატებით შეიქმნა';
$LNG['user_exists'] = 'ესეთი სახელი უკვე არსებობს.';
$LNG['email_exists'] = 'ესეთი E-Mail-ი უკვე არსებობს.';
$LNG['all_fields'] = 'აუცილებელია ყველა ველის შევსება!';
$LNG['user_alnum'] = 'სახელი უნდა შეიცავდეს მხოლოდ ციფრებს და ასოებს..';
$LNG['user_too_short'] = 'სახელი უნდა შეიცავდეს მინიმუმ 3 და მაქსიმუმ 32 ასოს.';
$LNG['invalid_email'] = 'თქვენი ელფოსტა არასწორია';
$LNG['invalid_user_pw'] = 'თქვენი ლოგინი ან პაროლი არასწორია.';
$LNG['invalid_captcha'] = 'უსაფრთხოების კოდი არასწორია!';
$LNG['log_out'] = 'საიტის დატოვება';
$LNG['hello'] = 'გამარჯობა';
$LNG['visitor'] = 'მომხმარებელო';
$LNG['register'] = 'რეგისტრაცია';
$LNG['login'] = 'ავტორიზაცია';
$LNG['password'] = 'პაროლი';
$LNG['username'] = 'სახელი';
$LNG['email'] = 'იმეილი';
$LNG['captcha'] = 'უსაფრთხოების კოდი';
